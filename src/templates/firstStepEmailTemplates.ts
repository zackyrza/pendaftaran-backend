const registrationFirstStepEmail = function (data: string) {
    const html = `
    <!DOCTYPE html>
...
Use this link to confirm your account and log in
                          ...
                          <lable style="display: block; font-size: 24px; line-height: 100%; margin-bottom: 24px; --text-opacity: 1; color: #000000; text-decoration: none;">${data}</lable>
    ...
    const text = `
        Email notifikasi bahwa anda telah melakukan registrasi di Pekan Olahraga Provinsi Kalimantan Tengah 2023`;
    return {
        html: html,
        text: text,
    };
